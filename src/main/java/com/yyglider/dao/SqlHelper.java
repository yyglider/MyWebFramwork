package com.yyglider.dao;


import com.yyglider.orm.EntityHelper;
import com.yyglider.utils.base.CollectionUtil;
import com.yyglider.utils.base.MapUtil;
import com.yyglider.utils.base.PropsUtil;
...
public class SqlHelper {
     ...
     * SQL 属性文件对象
     */
    private static final Properties sqlProps = PropsUtil.loadProps("smart-sql.properties");
    ...
    public static String getSql(String key) {
        ...
        if (sqlProps.containsKey(key)) {
            ...
            throw new RuntimeException("无法在 " + "smart-sql.properties" + " 文件中获取属性：" + key);
        }
        return sql;
    }
