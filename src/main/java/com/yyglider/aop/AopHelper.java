package com.yyglider.aop;

import com.yyglider.aop.annotation.Aspect;
import com.yyglider.aop.annotation.AspectOrder;
import com.yyglider.aop.proxy.Proxy;
import com.yyglider.aop.proxy.ProxyManager;
import com.yyglider.core.ClassHelper;
import com.yyglider.core.fault.InitializationError;
    ...
    static {
        try {
            ...
            for (Map.Entry<Class<?>, List<Proxy>> targetEntry : targetMap.entrySet()) {
                ...
                BeanManager.setBeanContainer(targetClass, proxyInstance);
            }
        } catch (Exception e) {
