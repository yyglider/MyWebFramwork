...
import com.yyglider.utils.base.CodecUtil;
...
public class DataContext {
     ...
     * 获取 DataContext 实例
     */
    public static DataContext getDataContextInstance() {
    ...
    public static HttpServletRequest getRequest() {
        return getDataContextInstance().request;
    }
    ...
    public static HttpServletResponse getResponse() {
        return getDataContextInstance().response;
    }
